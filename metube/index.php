...
<?php include('/var/www/spring13/g6/metube/header.php'); ?>

<?php include('/var/www/spring13/g6/metube/navindex.php'); ?>

<?php include('/var/www/spring13/g6/metube/tag_cloud.php'); ?>
...
while($crow = mysql_fetch_array($catresult))
{
	...
	?>
	<tr>
	<td><a href="index.php?category=<?php echo $category; ?>"><?php echo $category; ?></td></tr>
<?php } ?>
<tr><td><a href="index.php">All</a></td></tr>
</table>
<br>
<br>
<a href = "index.php?ru=1">Order the above media by <b><i>Most recently Uploaded</i></b></a> <br> <br>
<a href = "index.php?rv=1">Order the above media by <b><i>Most Viewed</i></b></a>
...
<?php include('/var/www/spring13/g6/metube/footer.php'); ?> 			
